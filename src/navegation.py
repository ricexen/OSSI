...
from src.actions.investigation import find_friends_of, find_friends_of_my_friends, get_connections
...
NAVEGATION_MENU_CONFIG = [
  ...
  },
  {
    ...
    'commands': [
      ...
      {'invest:connections': ['Fetch all id from friend list', get_connections, True]},
    ]
  },
  {
    'title': 'Bots',
